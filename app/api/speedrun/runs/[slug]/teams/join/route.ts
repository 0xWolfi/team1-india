...
export async function POST(
  ...
  try {
    ...
    let body: { teamCode?: unknown } = {};
    try {
      body = await request.json();
    } catch {
      // empty/invalid body — falls through to the missing-code check below
    }
    const teamCode =
    ...
    console.error("POST /api/speedrun/runs/[slug]/teams/join failed", err);
