                        ...
                        return (
                            <div key={qt}>
                                <h3 className="text-sm font-bold text-white mb-3 flex items-center gap-2">
                                    ...
                                    {QUEST_LABELS[qt]}
                                    <span className="text-[10px] text-zinc-600 font-normal">({lb.length} members)</span>
                                </h3>
                                {lb.length > 0 ? (
                                        ...
                                        {lb.map((entry, i) => (
                                            <div key={entry.email} className={cn("rounded-xl p-4 flex items-center gap-4", glassClass, i < 3 && "border-amber-500/10")}>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-[11px] text-zinc-600">{entry.email}</p>
                                                </div>
                                    ...
                                    <div className={cn("py-8 rounded-xl text-center border-dashed", glassClass)}>
                                        <p className="text-xs text-zinc-600">No approved submissions yet</p>
                                    </div>
                                )}
                            </div>
                        );
                                                ...
                                                return (
                                                    <div key={i} className="flex items-center gap-3 group">
                                                        ...
                                                        {isUrl ? (
                                                            ...
                                                            <span className="text-xs text-zinc-300 truncate">{link.url}</span>
                                                        )}
                                                    </div>
                                                );
                                            })}
