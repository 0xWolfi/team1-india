        ...
        return (
            <CoreWrapper>
                <div className="max-w-xl mx-auto pt-20 text-center space-y-6">
                    ...
                    <p className="text-sm text-zinc-400">Share this link with participants. They can open it, sign in, and fill the form.</p>
                    ...
                    <div className="flex items-center gap-3 justify-center pt-4">
                        <Link href="/core/campaigns" className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-white/5 border border-white/10 text-zinc-300 hover:bg-white/10 transition-colors">
                            View All Campaigns
                        </Link>
                        <button
