    ...
    <main className="min-h-screen bg-black text-white selection:bg-zinc-800 selection:text-zinc-200">
      ...
      <div className="pt-24 px-6 max-w-7xl mx-auto pb-20">
        ...
        <div className="space-y-6">
          {guides.map((item: any) => (
            <Link key={item.id} href={`/public/guides/${item.id}`} className="flex flex-row bg-zinc-950 border border-white/10 rounded-3xl overflow-hidden hover:border-white/20 transition-all group">
