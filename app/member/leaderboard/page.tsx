...
const rankConfig: Record<number, { bg: string; border: string; text: string; glow: string }> = {
    ...
    2: { bg: "bg-zinc-400/10", border: "border-zinc-400/30", text: "text-zinc-600 dark:text-zinc-300", glow: "shadow-zinc-400/10" },
    ...
    return (
        <div className={cn(
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                {/* Avatar */}
                <div className={cn(
                    "rounded-full bg-zinc-200 dark:bg-zinc-800 border flex items-center justify-center mb-2",
                    config.border,
                ...
                {/* Name */}
                <p className={cn(
                    "font-bold text-black dark:text-white truncate w-full",
                ...
                <div className="flex items-center gap-1.5 mt-3">
                    ...
                    <span className="text-xs text-zinc-500 dark:text-zinc-600">XP</span>
                </div>
                <p className="text-[11px] text-zinc-500 dark:text-zinc-600 mt-1">{entry.completedBounties} bounties</p>
            </div>
        </div>
    );
}
...
export default function LeaderboardPage() {
    ...
    return (
        <MemberWrapper>
            <div className="text-black dark:text-white max-w-[900px] mx-auto">
                {/* ── Header ── */}
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        {currentUserEntry && (
                            <div className={cn("px-4 py-2.5 rounded-xl flex items-center gap-3", glassClass, "border-amber-500/10")}>
                                ...
                                <div className="w-px h-6 bg-black/10 dark:bg-white/5" />
                ...
                {loading ? (
                        ...
                        <div className="grid grid-cols-3 gap-3 mb-8">
                            {[0, 1, 2].map(i => (
                                <div key={i} className={cn("rounded-2xl p-5 flex flex-col items-center animate-pulse", glassClass, i !== 1 && "mt-6")}>
                                    ...
                                    <div className="w-12 h-12 rounded-full bg-zinc-200 dark:bg-zinc-800 mb-2" />
                        ...
                        {[...Array(5)].map((_, i) => (
                            <div key={i} className={cn("rounded-xl p-4 flex items-center gap-4 animate-pulse", glassClass)}>
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="h-3 w-20 bg-zinc-200 dark:bg-zinc-800/50 rounded" />
                                </div>
                    ...
                    <div className={cn("py-20 rounded-2xl flex flex-col items-center justify-center border-dashed", glassClass)}>
                        <Trophy className="w-10 h-10 text-zinc-400 dark:text-zinc-700 mb-4" />
                    ...
                    <>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between px-4 py-2">
                                <span className="text-[11px] font-semibold text-zinc-500 dark:text-zinc-600 uppercase tracking-wider">All Rankings</span>
                                <span className="text-[11px] text-zinc-400 dark:text-zinc-700">{leaderboard.length} members</span>
                            </div>
                                    ...
                                    >
                                        ...
                                        <div className={cn(
                                            ...
                                            topRank
                                                ...
                                                : "bg-zinc-100 dark:bg-zinc-800/50 border-black/10 dark:border-white/5 text-zinc-500"
                                        )}>
                                            {entry.rank <= 3 ? (
                                        ...
                                        <div className={cn(
                                            ...
                                            topRank ? `${topRank.bg} ${topRank.border}` : "bg-zinc-200 dark:bg-zinc-800 border-black/10 dark:border-white/10"
                                        )}>
                                        ...
                                        {/* XP */}
                                        <div className="flex items-center gap-1.5 shrink-0 bg-zinc-100 dark:bg-zinc-800/30 px-3 py-1.5 rounded-lg border border-black/10 dark:border-white/5">
                                            <Zap className="w-3.5 h-3.5 text-amber-400" />
                                            <span className="text-sm font-bold text-amber-400 tabular-nums">{entry.totalXp}</span>
                                            <span className="text-[10px] text-zinc-500 dark:text-zinc-600">XP</span>
                                        </div>
                                    </div>
                                );
                            })}
