      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8">
        ...
        <div className="relative flex-1 group">
          ...
          <input
            ...
            className={cn(
              "w-full pl-11 pr-4 py-2.5 rounded-xl text-sm text-white",
            ...
            return viewMode === "grid" ? (
              ...
              <Link
                ...
                className={cn(
                  ...
                  "hover:-translate-y-1 hover:border-white/10 hover:shadow-xl hover:shadow-black/20",
              ...
              >
                ...
                <div className="flex-1 p-5 flex flex-col justify-between">
                  ...
                  {/* Footer */}
                  <div className="mt-4 flex items-center justify-between text-xs text-zinc-500 border-t border-white/6 pt-4">
                    <span>
                      by{" "}
              ...
              <Link
                ...
                className={cn(
                  ...
                  "bg-zinc-900/40 backdrop-blur-xl border border-white/6",
                  "hover:-translate-y-0.5 hover:border-white/10 hover:shadow-xl hover:shadow-black/20",
                  "transition-all duration-300"
                )}
              >
                {/* Image */}
                <div className="relative w-full sm:w-48 h-48 sm:h-auto shrink-0 overflow-hidden bg-zinc-900">
                  {item.coverImage ? (
                    <Image
                      src={item.coverImage}
                      alt={item.title}
                ...
                <div className="flex-1 p-5 flex flex-col justify-between min-w-0">
                  <div>
                    <div className="flex items-start justify-between gap-4 mb-2">
                      <h3 className="font-bold text-white text-base leading-snug line-clamp-1 flex-1">
                        {item.title}
                      </h3>
                      <span className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/10 text-[10px] font-bold text-zinc-500 uppercase tracking-wider group-hover:bg-white group-hover:text-black transition-all duration-300 whitespace-nowrap">
                        View
                  ...
                  {/* Footer */}
                  <div className="mt-3 flex items-center justify-between text-xs text-zinc-500 border-t border-white/6 pt-3">
                    <span>
                      by{" "}
                      <span className="text-zinc-400">
                        {item.createdBy?.name || "Team 1"}
