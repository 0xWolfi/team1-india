...
import { Search, LayoutGrid, List as ListIcon, Calendar, ChevronDown, MapPin } from "lucide-react";
        ...
        <div>
                ...
                >
                        ...
                        <div className={cn(
                            ...
                            <div className="absolute top-4 right-4">
                                <span className={cn(
                                    "flex items-center gap-1 px-3 py-1.5 rounded-lg border border-white/10 backdrop-blur-md text-[10px] font-bold text-white uppercase tracking-wider",
                                    "bg-black/60" // Always keep date visible with background
                                )}>
            ...
            {filteredEvents.length === 0 && (
                <div className="py-32 text-center border-2 border-dashed border-white/5 rounded-3xl">
                    <p className="text-zinc-500">No active events found.</p>
                </div>
            )}
        </div>
    );
