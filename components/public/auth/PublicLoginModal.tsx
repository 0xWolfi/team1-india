        ...
        <div className="p-8">
          ...
          <div className="space-y-6">
            <button
              onClick={handleLogin}
              disabled={isLoading}
              className="w-full py-3 px-4 rounded-xl font-bold transition-all flex items-center justify-center gap-2 bg-white text-black hover:bg-zinc-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
            ...
            <p className="text-xs text-center text-zinc-500">
               By continuing, you agree to set up your profile and accept our terms.
            </p>
          </div>
        </div>
      </div>
