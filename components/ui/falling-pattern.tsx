...
export function FallingPattern({
	color = '#555555', // Defaulting to a visible grey for dark mode
	backgroundColor = 'transparent',
	duration = 50, // Speed up a bit? Default 150 is very slow. User said "replace dot one". I'll keep default or slightly faster.
	blurIntensity = '1em',
	density = 1,
	className,
}: FallingPatternProps) {
