      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 p-8 border border-white/10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)] rounded-3xl bg-zinc-900/60 backdrop-blur-2xl">
          ...
          <div className="flex items-center gap-6">
            <Link href="https://t.me/team1india" target="_blank" className="text-zinc-400 hover:text-brand-500 transition-colors hover:scale-110 transform duration-200">
                <Send className="w-5 h-5" />
            </Link>
            <Link href="#" className="text-zinc-400 hover:text-brand-500 transition-colors hover:scale-110 transform duration-200">
